package com.strivemammoth.actiondriver;
...
public class ActionClass extends BaseClass {
	...
	public boolean selectByValue(WebElement element,String i) {
		boolean flag = false;
		try {
			Select s = new Select(element);
			s.selectByValue(i);
	...
	public void type(WebElement opentimeHRS, String property, String property2) {
